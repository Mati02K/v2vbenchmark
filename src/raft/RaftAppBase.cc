...
RaftAppBase::RaftAppBase()
    ...
    , fallbackClusterTimeoutMs_(150000)
    , intersectionStopTimeMs_(0)
    , batchExitPollMs_(500)
    , clusterMode_("cluster")
    , transportName_("unknown")
    , isPriorityVehicle_(false)
    , allowMultipleRounds_(false)
    ...
    , timeLeftIntersection_(SIMTIME_ZERO)
    , timePassed_(SIMTIME_ZERO)
    , totalRaftTimeSec_(0.0)
    , leaderElectionTimeMs_(0.0)
    , decisionLatencyMs_(0.0)
